...
* [zuke](https://github.com/zuke-build/zuke) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-14 - Code-first, strongly-typed build automation system where builds are defined as TypeScript classes.
* [swissknife](https://github.com/fakoua/SwissKnife) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2023-12-23 - SwissKnife - Deno Swiss Knife tools for Windows.

### CLI utils

* [yargs](https://github.com/yargs/yargs) ⭐ 11,511 | 🐛 215 | 🌐 JavaScript | 📅 2026-08-07 - The modern, pirate-themed successor to optimist.
* [cac](https://github.com/cacjs/cac) ⭐ 3,121 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-16 - Simple yet powerful framework for building command-line apps.
* [cliffy](https://github.com/c4spar/cliffy) ⭐ 1,173 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-16 - The complete solution for building interactive command-line tools.
...
* [commit-sage-cli](https://github.com/AhmedOsman101/commit-sage-cli) ⭐ 51 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-12 - Generates Conventional Commit messages with AI based on Git repository changes.
...
* [denodb](https://github.com/eveningkid/denodb) ⭐ 1,920 | 🐛 105 | 🌐 TypeScript | 📅 2023-10-28 - MySQL, SQLite, MariaDB, PostgreSQL and MongoDB ORM for Deno.
* [postgres](https://github.com/denodrivers/postgres) ⭐ 655 | 🐛 38 | 🌐 TypeScript | 📅 2025-04-24 - Driver for PostgreSQL database.
...
* [deno\_mongo](https://github.com/denodrivers/mongo) ⭐ 512 | 🐛 48 | 🌐 TypeScript | 📅 2025-03-14 - MongoDB database driver.
* [redis](https://github.com/denodrivers/redis) ⭐ 466 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-11 - An experimental implementation of redis client for deno.
...
* [maxminddb](https://github.com/josh-hemphill/maxminddb-wasm) ⭐ 18 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-02 - A library that enables the usage of MaxmindDB geoIP database files
...
* [Denops](https://github.com/vim-denops/denops.vim) ⭐ 789 | 🐛 9 | 🌐 TypeScript | 📅 2026-07-02 - 🐜 An ecosystem to write Vim/Neovim plugins with Deno.

### Frontend framework

* [fresh](https://github.com/denoland/fresh) ⭐ 13,786 | 🐛 147 | 🌐 TypeScript | 📅 2026-08-02 - The next-gen web framework.
* [ultra](https://github.com/exhibitionist-digital/ultra) ⭐ 2,949 | 🐛 28 | 🌐 TypeScript | 📅 2024-10-28 - 💎 Modern Streaming React Framework in Deno.
...
* [caviar](https://github.com/load1n9/caviar) ⭐ 172 | 🐛 4 | 🌐 TypeScript | 📅 2025-09-03 - ⚡ Blazing fast, modern, Game Engine powered by WebGPU for Deno and the browser
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,963 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-12 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [LiteMarkup](https://github.com/tuures/LiteMarkup) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-13 - AST-first parser. Under 3 KB gzipped, zero dependencies.
...
* [lume](https://github.com/lumeland/lume) ⭐ 2,274 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-10 - A static site generator similar to Jekyll or Eleventy with support for multiple file formats.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,718 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-17 - Telegram Bot API framework for Deno.
* [discordeno](https://github.com/discordeno/discordeno) ⭐ 941 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-16 - Discord API library for Deno
* [MTKruto](https://github.com/MTKruto/MTKruto) ⭐ 171 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-15 - Deno-first, cross-runtime client library for Telegram's MTProto API.

### Template engine

* [eta](https://github.com/bgub/eta) ⭐ 1,752 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-25 - Fast, lightweight, and configurable embedded template engine.
...
* [unexpected](https://github.com/unexpectedjs/unexpected) ⭐ 368 | 🐛 51 | 🌐 JavaScript | 📅 2026-04-14 - Extensible BDD assertion toolkit.
...
* [superoak](https://github.com/cmorten/superoak) ⭐ 121 | 🐛 2 | 🌐 TypeScript | 📅 2026-07-23 - HTTP assertions for Oak made easy via SuperDeno.
* [rhum](https://github.com/drashland/rhum) ⭐ 90 | 🐛 8 | 🌐 TypeScript | 📅 2024-05-31 - A lightweight testing framework for Deno.
* [qunitx](https://github.com/izelnakri/qunitx) ⭐ 35 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-14 - Zero dependency, fully customizable, mature, universal test API that can run interchangably in node.js, Deno & browser, using default runtime test runners.
* [tepi](https://deno.land/x/tepi) - A .http Test Runner

### Utils

* [croner](https://github.com/Hexagon/croner) ⭐ 2,582 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-08 - Cron library with advanced scheduling features, well-documented API, and zero dependencies.
* [fastest-validator](https://github.com/icebob/fastest-validator) ⭐ 1,463 | 🐛 44 | 🌐 JavaScript | 📅 2026-04-09 - Schema validator for all javascript platforms
...
* [qrcode](https://github.com/denorg/qrcode) ⭐ 45 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-25 - QR code image generator for Deno.
...
* [envapt](https://github.com/materwelonDhruv/envapt) ⭐ 22 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-10 - Read environment variables as typed values with built-in converters, Standard Schema validation, and zero dependencies.
...
* [csv-pipe](https://github.com/martsinlabs/csv-pipe) ⭐ 13 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-31 - Typed, zero-dependency CSV parser and encoder for every runtime.
...
* [switcher4deno](https://github.com/switcherapi/switcher-client-deno) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-26 - Feature Flag Deno SDK client for Switcher-API.
* [dinoenv](https://deno.land/x/dinoenv) - tiny library to manage environment variables with deno.

### Validation

* [zod](https://github.com/colinhacks/zod) ⭐ 43,474 | 🐛 158 | 🌐 TypeScript | 📅 2026-08-17 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 31,700 | 🐛 366 | 🌐 TypeScript | 📅 2026-08-17 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [drash](https://github.com/drashland/drash) ⭐ 1,067 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12 - A REST microframework for Deno's HTTP server with zero dependencies.
...
* [alosaur](https://github.com/alosaur/alosaur) ⭐ 818 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-24 - Alosaur - Deno web framework with many ES Decorators.
* [danet](https://github.com/Savory/Danet) ⭐ 526 | 🐛 3 | 🌐 HTML | 📅 2026-08-17 - A Savory web framework for Deno heavily inspired by [Nest.js](https://nestjs.com).
...
* [faster](https://github.com/hviana/faster) ⭐ 57 | 🐛 0 | 🌐 TypeScript | 📅 2025-08-01 - A fast and optimized middleware server with a set of useful middlwares.

### WebSocket

* [wocket](https://github.com/drashland/wocket) ⭐ 101 | 🐛 2 | 🌐 TypeScript | 📅 2024-05-02 - A WebSocket library for Deno.
...
* [obsidian](https://github.com/open-source-labs/obsidian) ⭐ 765 | 🐛 4 | 🌐 TypeScript | 📅 2024-05-17 - A native GraphQL caching client and server module.
...
* [ts-prometheus](https://github.com/marcopacini/ts_prometheus) ⭐ 32 | 🐛 1 | 🌐 TypeScript | 📅 2023-11-14 - A prometheus client.
* [rpc](https://github.com/deno-libs/rpc) ⭐ 23 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-06 - JSONRPC server implementation for Deno.
* [forwarded](https://github.com/deno-libs/forwarded) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-26 - Deno port of `forwarded` library.
* [graphql-tag](https://github.com/deno-libs/graphql_tag) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-07 - GraphQL schema AST from template literal.
...
* [sax-ts](https://github.com/Maxim-Mazurok/sax-ts) ⭐ 20 | 🐛 0 | 🌐 JavaScript | 📅 2024-03-17 - SAX-style XML parser ported from [sax-js](https://github.com/isaacs/sax-js) ⭐ 1,158 | 🐛 98 | 🌐 JavaScript | 📅 2026-07-24.
...
* [GitHub Profile Trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,632 | 🐛 32 | 🌐 TypeScript | 📅 2026-07-25 - 🏆 Add dynamically generated GitHub Trophy on your readme
* [Edrys](https://github.com/edrys-org/edrys) ⭐ 335 | 🐛 8 | 🌐 Vue | 📅 2024-08-12 - Remote Teaching Software
* [Deno Rest](https://github.com/Prolifode/deno_rest) ⭐ 162 | 🐛 3 | 🌐 TypeScript | 📅 2025-02-09 - A Boilerplate for deno RESTful apis.
* [Chobble Tickets](https://github.com/chobbledotcom/tickets) ⭐ 29 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-17 - Open source ticket sales system with encrypted attendee data and Stripe, Square, or SumUp payments.
...
* [vscode-deno](https://github.com/denoland/vscode_deno) ⭐ 1,548 | 🐛 125 | 🌐 TypeScript | 📅 2026-07-02 - VS Code extension that provides Deno support using the `TypeScript Deno language service plugin`.
* [dnt](https://github.com/denoland/dnt) ⭐ 1,333 | 🐛 63 | 🌐 Rust | 📅 2026-08-03 - Deno to npm package build tool.
...
* [deno\_docker](https://github.com/denoland/deno_docker) ⭐ 1,018 | 🐛 18 | 🌐 Dockerfile | 📅 2026-08-06 - Latest dockerfiles and images for Deno - alpine, centos, debian, ubuntu.
...
* [trex](https://github.com/crewdevio/Trex) ⭐ 727 | 🐛 7 | 🌐 TypeScript | 📅 2023-08-18 - Package management like npm for deno.
...
* [denoflow](https://github.com/denoflow/denoflow) ⭐ 287 | 🐛 0 | 🌐 TypeScript | 📅 2023-10-04 - Configuration as code, use YAML to write automated workflows that run on Deno, with any Deno modules, Typescript/Javascript codes
...
* [studio-pack-generator](https://github.com/jersou/studio-pack-generator) ⭐ 122 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-28 - Convert a folder or a RSS URL to Studio pack for Lunii device
...
* [make-deno-edition](https://github.com/bevry/make-deno-edition) ⭐ 42 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-12 - Automatically makes package.json projects (such as npm packages and node.js modules) compatible with Deno.
...
* dvm
  * [justjavac/dvm](https://github.com/justjavac/dvm) ⭐ 708 | 🐛 1 | 🌐 Rust | 📅 2026-08-05 - Deno Version Manager: manage multiple active Deno versions.
  * [axetroy/dvm](https://github.com/axetroy/dvm) ⭐ 165 | 🐛 14 | 🌐 Go | 📅 2024-08-27 - Version manger for Deno without runtime dependencies.
  * [asdf-community/asdf-deno](https://github.com/asdf-community/asdf-deno) ⭐ 132 | 🐛 9 | 🌐 Shell | 📅 2026-07-20 - Deno plugin for [asdf](https://asdf-vm.com/)
