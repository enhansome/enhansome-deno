...
* [zuke](https://github.com/zuke-build/zuke) ⭐ 38 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 - Code-first, strongly-typed build automation system where builds are defined as TypeScript classes.
* [swissknife](https://github.com/fakoua/SwissKnife) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2023-12-23 - SwissKnife - Deno Swiss Knife tools for Windows.

### CLI utils

* [yargs](https://github.com/yargs/yargs) ⭐ 11,511 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04 - The modern, pirate-themed successor to optimist.
* [cac](https://github.com/cacjs/cac) ⭐ 3,131 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-28 - Simple yet powerful framework for building command-line apps.
* [cliffy](https://github.com/c4spar/cliffy) ⭐ 1,176 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-16 - The complete solution for building interactive command-line tools.
...
* [redis](https://github.com/denodrivers/redis) ⭐ 466 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-07 - An experimental implementation of redis client for deno.
...
* [fresh](https://github.com/denoland/fresh) ⭐ 13,787 | 🐛 151 | 🌐 TypeScript | 📅 2026-08-02 - The next-gen web framework.
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,990 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-06 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [LiteMarkup](https://github.com/tuures/LiteMarkup) ⭐ 2 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-07 - AST-first parser. Under 3 KB gzipped, zero dependencies.
...
* [lume](https://github.com/lumeland/lume) ⭐ 2,279 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-07 - A static site generator similar to Jekyll or Eleventy with support for multiple file formats.
...
* [discordeno](https://github.com/discordeno/discordeno) ⭐ 942 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-06 - Discord API library for Deno
...
* [croner](https://github.com/Hexagon/croner) ⭐ 2,589 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Cron library with advanced scheduling features, well-documented API, and zero dependencies.
...
* [envapt](https://github.com/materwelonDhruv/envapt) ⭐ 22 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-07 - Read environment variables as typed values with built-in converters, Standard Schema validation, and zero dependencies.
...
* [zod](https://github.com/colinhacks/zod) ⭐ 43,889 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-07 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 32,118 | 🐛 392 | 🌐 TypeScript | 📅 2026-09-06 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [Chobble Tickets](https://github.com/chobbledotcom/tickets) ⭐ 31 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-08 - Open source ticket sales system with encrypted attendee data and Stripe, Square, or SumUp payments.
