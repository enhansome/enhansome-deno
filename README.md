...
* [zuke](https://github.com/zuke-build/zuke) ⭐ 39 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-11 - Code-first, strongly-typed build automation system where builds are defined as TypeScript classes.
* [swissknife](https://github.com/fakoua/SwissKnife) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2023-12-23 - SwissKnife - Deno Swiss Knife tools for Windows.

### CLI utils

* [yargs](https://github.com/yargs/yargs) ⭐ 11,506 | 🐛 212 | 🌐 JavaScript | 📅 2026-09-11 - The modern, pirate-themed successor to optimist.
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,993 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-12 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,740 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-26 - Telegram Bot API framework for Deno.
* [discordeno](https://github.com/discordeno/discordeno) ⭐ 943 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-10 - Discord API library for Deno
...
* [croner](https://github.com/Hexagon/croner) ⭐ 2,590 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-31 - Cron library with advanced scheduling features, well-documented API, and zero dependencies.
...
* [zod](https://github.com/colinhacks/zod) ⭐ 43,930 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-11 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 32,162 | 🐛 389 | 🌐 TypeScript | 📅 2026-09-10 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [Chobble Tickets](https://github.com/chobbledotcom/tickets) ⭐ 31 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-12 - Open source ticket sales system with encrypted attendee data and Stripe, Square, or SumUp payments.
