...
* [zuke](https://github.com/zuke-build/zuke) ⭐ 38 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-10 - Code-first, strongly-typed build automation system where builds are defined as TypeScript classes.
* [swissknife](https://github.com/fakoua/SwissKnife) ⭐ 10 | 🐛 1 | 🌐 TypeScript | 📅 2023-12-23 - SwissKnife - Deno Swiss Knife tools for Windows.

### CLI utils

* [yargs](https://github.com/yargs/yargs) ⭐ 11,506 | 🐛 211 | 🌐 JavaScript | 📅 2026-09-04 - The modern, pirate-themed successor to optimist.
...
* [commit-sage-cli](https://github.com/AhmedOsman101/commit-sage-cli) ⭐ 55 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-10 - Generates Conventional Commit messages with AI based on Git repository changes.
...
* [fresh](https://github.com/denoland/fresh) ⭐ 13,786 | 🐛 151 | 🌐 TypeScript | 📅 2026-08-02 - The next-gen web framework.
...
* [LogTape](https://github.com/dahlia/logtape) ⭐ 1,991 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-09 - Simple logging library with zero dependencies for Deno/Node.js/Bun/browsers.
...
* [LiteMarkup](https://github.com/tuures/LiteMarkup) ⭐ 2 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-10 - AST-first parser. Under 3 KB gzipped, zero dependencies.
...
* [lume](https://github.com/lumeland/lume) ⭐ 2,280 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-07 - A static site generator similar to Jekyll or Eleventy with support for multiple file formats.
...
* [grammY](https://github.com/grammyjs/grammY) ⭐ 3,740 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-26 - Telegram Bot API framework for Deno.
* [discordeno](https://github.com/discordeno/discordeno) ⭐ 943 | 🐛 105 | 🌐 TypeScript | 📅 2026-09-10 - Discord API library for Deno
...
* [eta](https://github.com/bgub/eta) ⭐ 1,759 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-25 - Fast, lightweight, and configurable embedded template engine.
...
* [envapt](https://github.com/materwelonDhruv/envapt) ⭐ 22 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-09 - Read environment variables as typed values with built-in converters, Standard Schema validation, and zero dependencies.
...
* [zod](https://github.com/colinhacks/zod) ⭐ 43,926 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-11 - TypeScript-first schema validation with static type inference.

### Web framework

* [hono](https://github.com/honojs/hono) ⭐ 32,153 | 🐛 389 | 🌐 TypeScript | 📅 2026-09-10 - Ultrafast web framework for Cloudflare Workers, Deno, and Bun. Fast, but not only fast.
...
* [Chobble Tickets](https://github.com/chobbledotcom/tickets) ⭐ 31 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-11 - Open source ticket sales system with encrypted attendee data and Stripe, Square, or SumUp payments.
